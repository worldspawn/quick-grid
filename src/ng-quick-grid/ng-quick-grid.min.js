...
!function(){"use strict";function t(t,n){this.value=t,this.toJSON=function(){if(this.value){var t=this.value;return t.toJSON&&(t=t.toJSON()),n+t}}}function n(t){this.sort(t)}function i(t,i){this.model=i||{},this.paging=new n(t),this.pageCount=[],this.filters={}}var o={"%":function(t){this.value=t,this.toJSON=function(){if(this.value){var t=this.value;return t.toJSON&&(t=t.toJSON()),"%"+t+"%"}}},"%~":function(t){this.value=t,this.toJSON=function(){if(this.value){var t=this.value;return t.toJSON&&(t=t.toJSON()),"%"+t}}},"~%":function(t){this.value=t,this.toJSON=function(){if(this.value){var t=this.value;return t.toJSON&&(t=t.toJSON()),t+"%"}}},"()":function(t){this.value=t,this.toJSON=function(){if(this.value){var t=[];return this.value.forEach(function(n){n.toJSON?t.push(n.toJSON()):t.push(n)}),"("+t.join(",")+")"}}}};i.prototype={addFilter:function(n,i,e){var u=o[i]||t;this.filters[n]=new u(e,i)},attachToScope:function(t,n){function i(){o.paging.pageIndex=0,o.paging.filterHash=null,n(angular.extend({},o.model,{filters:o.filters}),o.paging,!0).then(function(t){null!==t.pageCount&&(o.pageCount.length=t.pageCount),o.paging.filterHash=t.filterHash})}var o=this;t.$watch(function(){return o.model},i,!0),t.$watch(function(){return o.filters},i,!0),t.$watch(function(){return o.paging},function(t,i){t.sortBy===i.sortBy&&t.pageIndex===i.pageIndex||n(o.model,t,!1)},!0)}},n.prototype={sort:function(t){null===t?delete this.sortBy:t===this.sortBy?this.sortBy=t+" desc":this.sortBy=t},toPage:function(t){this.pageIndex=t}},angular.module("ngQuickGrid").factory("SearchModel",function(){return i})}();